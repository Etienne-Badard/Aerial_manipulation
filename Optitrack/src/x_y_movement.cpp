...
int main(int argc, char **argv)
{
    ...
    ros::Rate rate(20.0);
    int count = 0;
    ROS_INFO("Experiment 2 = x & y movement 3 pls");
    ...
    pose_forward.pose.position.z = 1.07;
    ...
    pose_lateral.pose.position.z = 1.07;
    ...
    pose_down.pose.position.z = 0.36;
